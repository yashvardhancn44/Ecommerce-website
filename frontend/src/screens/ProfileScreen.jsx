...
import { Table, Form, Button, Row, Col, FormGroup, FormControl} from 'react-bootstrap';
...
const ProfileScreen = () => {
  ...
  return (
    <Row>
      ...
      <Col md={9}>
        <h2>My Orders</h2>
        {loadingMyOrders?<Loader/>:error?(<Message variant='danger'>{error?.data?.message || error.error}</Message>):(
